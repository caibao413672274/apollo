...
public class RoleType {
  ...
  public static final String LOOKUP_NAMESPACE = "LookUpNamespace";
  public static boolean isValidRoleType(String roleType) {
    return MASTER.equals(roleType) || MODIFY_NAMESPACE.equals(roleType) || LOOKUP_NAMESPACE.equals(roleType)|| RELEASE_NAMESPACE.equals(roleType);
  }
